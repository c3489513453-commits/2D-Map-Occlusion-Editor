export class InferenceControls{
 constructor({state,editor,api,toast,elements}){this.state=state;this.editor=editor;this.api=api;this.toast=toast;this.el=elements;this.pending=null;this.previewId=null;this.bind()}
